  ...
  return (
    <section className=" grid justify-center gap-4 ">
      <div className=" grid justify-center m-auto  text-center  ">
        ...
        <h4 className=" align-element max-w-xl text-lg leading-8">
          We've got more browsers in the pipeline. Please do let us know if
          you've got a favourite you'd like us to prioritize.
        </h4>
      </div>
      <div className=" ml-3">
        <article className="grid grid-row-3 gap-2 lg:grid-cols-3 gap-8 relative">
          <div className=" rounded grid justify-center text-center shadow shadow-gray-900  ">
            <img
          ...
          <div className="rounded text-center grid justify-center shadow shadow-gray-900 lg:relative top-10 left-10  ">
            <img
          ...
          <div className=" rounded text-center grid justify-center shadow shadow-gray-900  lg:relative top-20 left-20 ">
            <img
